...
public class SecurityCredentialsConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers(HttpMethod.POST, "/api/v1/employee/employee/**").permitAll()
                .antMatchers(HttpMethod.POST, "/api/v1/employee/employee/save").permitAll()
                .antMatchers(HttpMethod.PUT, "/api/v1/employee/employee/update").permitAll()
                .antMatchers(HttpMethod.DELETE, "/api/v1/employee/employee/delete").permitAll()
                .antMatchers(HttpMethod.GET, "/api/v1/employee/employee/list").permitAll()
                .antMatchers(HttpMethod.GET, "/api/v1/employee/employee/find").permitAll()
                .antMatchers(HttpMethod.GET, "/api/v1/access/access/**").permitAll()
                .antMatchers(HttpMethod.GET, "/api/v1/access/users").anonymous()
